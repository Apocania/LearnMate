...
- 课程创建、编辑、删除、浏览。
- 学生加入课程、退出课程。
- 讨论区 Markdown 发帖、附件、评论、点赞、评论删除、伴学师删除帖子。
...
- 游客可以浏览帖子和评论。
- 登录用户可以使用 Markdown 和附件发帖、评论、点赞。
- 登录用户可以删除自己的评论。
- 伴学师可以删除帖子和评论。
- 帖子显示点赞数、评论数、是否已点赞。
- 帖子可展示附件下载入口。
- 长帖在列表中会自动折叠，避免帖子高度被超长正文撑开。
- 展开全文、点赞、评论三个操作统一放在帖子右下角横向排列。
- 前端评论区已从详情弹窗改为帖子内展开评论，发帖成功后不会再自动跳入评论视图。
- 发帖已从小弹窗升级为独立页面，支持正文编辑和实时预览。
- 点赞和评论会给帖子作者产生消息提醒。
...
- 游客可浏览帖子和评论。
- 学生和伴学师可使用 Markdown 正文和附件发帖、评论、点赞。
- 学生和伴学师可删除自己的评论。
- 伴学师可删除帖子和任意评论。
