...
from app.modules.reports.schemas import LearningProgressItem, MyLearningReport, TeachingCourseSummary
...
class LearningReportService:
  ...
  def get_my_report(self, current_user: User) -> MyLearningReport:
    ...
    estimated_study_hours = (
      round(course_count * 1.5 + interaction_count * 0.25 + ai_question_count * 0.15 + uploaded_file_count * 0.2, 1)
